namespace DBuddyBot.Data
{
    internal static class SqlStrings
    {
        ...
        /// </summary>
        internal const string InsertEmoji = "INSERT INTO emojis(id, name, role) VALUES ($emojiId, $emojiName, $emojiRole);";
        ...
        /// Parameters: $name
        /// </summary>
        internal const string SelectCategoryOnName = "SELECT ca.id AS categoryId, ca.name AS categoryName, ca.message as categoryMessage, ch.id AS channelId, ro.id AS roleId, ro.name AS roleName, ro.game AS roleGame, em.id as emojiId, em.name as emojiName "
        ...
        /// </summary>
        internal const string SelectCategoryOnMessage = "SELECT ca.id AS categoryId, ca.name AS categoryName, ca.message as categoryMessage, ch.id AS channelId, ro.id AS roleId, ro.name AS roleName, ro.game AS roleGame, em.id as emojiId, em.name as emojiName "
        ...
        /// Parameters: $name
        /// </summary>
        internal const string SelectRoleOnName = "SELECT roles.id, roles.name, roles.game, emojis.id, emojis.name FROM roles JOIN emojis ON roles.id = emojis.role WHERE lower(roles.name) = $name;";

        /// <summary>
        /// Parameters: $id
        /// </summary>
        internal const string SelectRoleOnId = "SELECT roles.id, roles.name, roles.game, emojis.id, emojis.name FROM roles JOIN emojis ON roles.id = emojis.role WHERE roles.id = $id;";

        /// <summary>
        /// Parameters: $emojiName
        /// </summary>
        internal const string SelectRoleOnEmoji = "SELECT roles.id, roles.name, roles.game, emojis.id, emojis.name FROM roles JOIN emojis ON roles.id = emojis.role WHERE emojis.name = $emojiName;";
        ...
        /// Parameters: $id
        /// </summary>
        internal const string DeleteEmojiOnRoleId = "DELETE FROM emojis WHERE role = $id;";

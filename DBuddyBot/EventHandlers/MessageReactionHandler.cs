...
namespace DBuddyBot.EventHandlers
{
    public static class MessageReactionHandler
    {
        ...
        public static Task MessageReactionAddedEventHandler(DiscordClient sender, DSharpPlus.EventArgs.MessageReactionAddEventArgs e)
        {
        ...
        public static Task MessageReactionRemovedEventHandler(DiscordClient sender, DSharpPlus.EventArgs.MessageReactionRemoveEventArgs e)
        {
            if (e.User == sender.CurrentUser)
            {
                return Task.CompletedTask;
